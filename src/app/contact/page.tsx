              ...
              <div className="bg-gray-100 rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="p-2 bg-white border-t border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-700 mb-1">Andover Chess Club</h3>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href={`tel:${contactInfo.phone}`} className="hover:text-emerald-800 transition-colors">
                        {contactInfo.phone}
                      </a>
                    </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href={`mailto:${contactInfo.email}`} className="hover:text-emerald-800 transition-colors">
                        {contactInfo.email}
                      </a>
                    </p>
                    {/* <p className="text-sm text-gray-500 mt-1">
      ...
      <section className="bg-white pt-5 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">How do I join the club?</h3>
              <p className="text-gray-600">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">What are the membership fees?</h3>
              <p className="text-gray-600">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Are beginners welcome?</h3>
              <p className="text-gray-600">
