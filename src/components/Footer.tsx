        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 dark:text-gray-400 mb-4">
              A welcoming community of chess enthusiasts in Andover, Hampshire. 
              We welcome players of all skill levels, from beginners to masters.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/members" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  Members
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300 dark:text-gray-400">
              <p>Andover Community Centre</p>
              <p>123 High Street</p>
              <p>Andover, SP10 1AA</p>
              <p className="mt-4">
                <a href="mailto:info@andoverchessclub.co.uk" className="hover:text-white transition-colors">
                  info@andoverchessclub.co.uk
                </a>
              </p>
              <p>
